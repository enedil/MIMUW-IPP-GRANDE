 ...
 * @param[in] visited       - tablica odwiedzonych wierzchołków (przez które nie wolno przechodzić)
 ...
 * @param[in] fixing        - jeśli @p fixing jest prawdziwy, wzięcie bezpośredniej drogi z A do B
 * jest zabronione
 * @return Wartośc logiczna, czy udało się przeprowadzić wyszukiwanie - czy alokacje pamięci się powiodły, czy
 * źródło jest różne od celu.
 */
